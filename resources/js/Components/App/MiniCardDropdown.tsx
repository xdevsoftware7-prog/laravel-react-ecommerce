      ...
      >
        <div className="card-body">
          ...
          <div className="my-4 max-h-[300px] overflow-auto">
            ...
            <pre className="text-xs max-w-full overflow-x-auto p-2 bg-gray-100 rounded">
              {JSON.stringify(miniCartItems, null, 2)}
            </pre>
            <div>
...
export default MiniCardDropdown;